...
public interface Cell<C> {
   ...
   * org.gwtproject.event.dom.client.BrowserEvents BrowserEvents} for useful constants). The container
   * that uses this cell should only pass these events to {@link #onBrowserEvent(Context, HTMLElement,
   * Object, Event, ValueUpdater)} when the event occurs.
   *
   ...
   * @see org.gwtproject.event.dom.client.BrowserEvents
   */
