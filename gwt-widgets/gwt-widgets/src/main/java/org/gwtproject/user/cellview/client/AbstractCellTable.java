      ...
      if (!skipRowHoverCheck) {
        ...
        if (BrowserEvents.MOUSEOVER.equals(eventType)) {
          ...
          if (!skipRowHoverFloatElementCheck) {
            ...
            double clientX = mouseEvent.clientX + DomGlobal.document.documentElement.scrollLeft;
            double clientY = mouseEvent.clientY + DomGlobal.document.documentElement.scrollTop;
